...
angular
    ...
    .directive('productList', function (Product, $http) {
        return {
            restrict: 'AE',
            replace: 'true',
            templateUrl: '/Assets/Design-5984225f/templates/product-table-short-term-finance.html',
            link: function ($scope, element, attributes) {
                ...
                $scope.openXvalues = function (feed, counter) {
                    ...
                    //$http.get('http://adtracker.quiddicompare.co.uk/www/delivery/ajs.php?zoneid=35&amp;block=1&amp;exclude=,bannerid:288,&amp;charset=UTF-8&amp;loc=http%3A//adtracker.quiddicompare.co.uk/www/admin/zone-invocation.php%3Faffiliateid%3D4%26zoneid%3D9&amp;referer=http%3A//adtracker.quiddicompare.co.uk/www/admin/zone-invocation.php%3Faffiliateid%3D4%26zoneid%3D9&context=YjoyODh8&amp;mmm_fo=1'
                ...
                //
                //    //return parseFloat(str.replace('£', item[$scope.listOrder]));
                //
                //    if (isNaN(item[$scope.listOrder])) {
                //        return item[$scope.listOrder];
                //    } else
                //        item[$scope.listOrder].replace(',', '');
                //    item[$scope.listOrder].replace('%', '');
                //    item[$scope.listOrder].replace('£', '');
                //    return parseFloat(item[$scope.listOrder]);
                //};
